...
#define DXL_FR_MINIMUM_POSITION_VALUE      2152             // FR ID 1  MIN
#define DXL_FR_MID_POSITION_VALUE          2588             // FR ID 1  MIDDLE
#define DXL_FR_MAXIMUM_POSITION_VALUE      2986              // FR ID 1  MAX
